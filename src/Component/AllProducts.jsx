        ...
        {products.map((product, idx) => (
          <div className="bg-slate-200 rounded-md shadow-2xl " key={idx}>
            ...
            <div className="p-1 lg:p-4 flex justify-between">
              <div className="">
                <h2 className="bg-slate-300 rounded-full my-2 px-2 ">Name: {product.name}</h2>
                <h2 className="bg-slate-300 rounded-full my-2 px-2 ">Type: {product.type}</h2>
                <h2 className="bg-slate-300 rounded-full my-2 px-2 ">Price: {product.price}$</h2>
              </div>
              <div className="text-right">
                <h2 className="capitalize bg-slate-300 rounded-full my-2 px-2 ">Brand: {product.brandName}</h2>
                <h2 className="bg-slate-300 rounded-full my-2 px-2 ">Rating: {product.rating}</h2>
              </div>
            </div>
